...
import com.forcat.shop.dto.CartDetailDto;
import com.forcat.shop.entity.CartItem;
...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
    ...
    @Query("select new com.forcat.shop.dto.CartDetailDto(ci.id, i.itemNm, i.price, ci.count, im.imgUrl) " +
